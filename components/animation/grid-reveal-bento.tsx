...
export const RevealBento: React.FC = () => {
  return (
...
const HeaderBlock: React.FC = () => (
  <Block className="col-span-12 row-span-2 md:col-span-6">
    ...
    />
    <h1 className="mb-12 text-4xl leading-tight font-medium">
      Hi, I'm Tom.{" "}
...
const EmailListBlock: React.FC = () => (
  <Block className="col-span-12 md:col-span-9">
    ...
    >
      ...
      <button
        type="submit"
        className="flex items-center gap-2 rounded bg-zinc-50 px-3 py-2 text-sm font-medium whitespace-nowrap text-zinc-900 transition-colors hover:bg-zinc-300"
      >
